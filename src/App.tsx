  ...
  return (
    <div className="min-h-screen containerDiv ">
      <div className="" >
        ...
        {/* Hero Section */}
        <motion.section
          className="min-h-screen container mx-auto px-6 max-w-7xl flex items-center justify-start  pt-20 pb-32 relative overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="absolute inset-0 -z-10">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23a0aec0' fill-opacity='0.2' fill-rule='evenodd'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/svg%3E\")",
              }}
            ></div>
          </div>
          ...
          <div>
            ...
            >
              ...
              <motion.h1
                ...
                style={{ textShadow: "1px 1px 30px white" }}
              >
              ...
              {[
                {
                  ...
                  image:
                    "https://via.placeholder.com/600x400/1f2937/9ca3af?text=Project+One",
                },
                {
                  title: "Project Two",
                  description:
                    "An AI-powered tool that helps developers write better code faster.",
                  tags: ["Python", "TensorFlow", "FastAPI"],
                  image:
                    "https://via.placeholder.com/600x400/1f2937/9ca3af?text=Project+Two",
                },
                {
                  title: "Project Three",
                  description:
                    "A mobile-first progressive web app for task management.",
                  tags: ["React Native", "Firebase", "Redux"],
                  image:
                    "https://via.placeholder.com/600x400/1f2937/9ca3af?text=Project+Three",
                },
              ].map((project, index) => (
                <motion.div
                  key={project.title}
                ...
                >
                  ...
                  <div className="flex space-x-4 mt-6">
                    ...
                    <a href="#" className="text-gray-400 flex items-center group">
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                <a
                  href="#"
                  className="text-gray-500 hover:text-indigo-300 transition-colors duration-300 text-sm"
                >
                  Privacy Policy
                </a>
                <a
